  	...
  	<div className="page">
        ...
        <div className="projects">
        	...
        	<div className="project d-flex">
        		<a href="https://kodfinder.netlify.app" target="_blank" rel="noopener noreferrer">
        	...
        	<div className="project d-flex">
        		<a href="https://planosfalemais.netlify.com/" target="_blank" rel="noopener noreferrer">
        	...
        	<div className="project d-flex">
        		<a href="https://sutolix.github.io/calculator/" target="_blank" rel="noopener noreferrer">
